...
for (let i = 0; i < 46; i++) {
    data.push({
        ...
        productBrand: 'Preety',
        productGroup: 'Food',
        profile_picture: 'https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60'
    });
}
...
<input type="text" placeholder="Search category..." className="w-full ml-1 placeholder:text-[#D9D9D9]" />
            ...
            <div className='flex-1'>
                <Table rowSelection={rowSelection} columns={columns} dataSource={data} pagination={{ pageSize: 4 }} onRow={(record) => {
                    // console.log(record);
                    return {
                        onDoubleClick: (_) => {
