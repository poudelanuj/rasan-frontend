...
function AddProductPack({ alert, setAlert }) {
  ...
  const {
    mutate: AddProductPackMutate,
    isLoading: addProductPackIsLoading,
    data: addProductPackResponseData,
  } = useMutation(({ form_data }) => createProductPack({ form_data }), {
    onSuccess: (data) => {
      message.success("Product Pack created successfully");
  ...
  const handleSave = async () => {
    if (
      ...
      AddProductPackMutate({ form_data });
      return addProductPackResponseData?.data?.data.slug;
    } else {
        ...
        >
          ...
          <div className="flex justify-end">
            <button
              ...
              type="button"
              onClick={async () => closeAddProductPWidget()}
            >
              Cancel
            </button>
            <button
